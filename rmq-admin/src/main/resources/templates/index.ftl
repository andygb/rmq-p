...
<#assign clientVersion=((data.clientVersion)!'')>
...
<#--<script src="js/jquery/jquery.form.js?v=${clientVersion}"></script>-->
...
<script type="text/javascript">
    ...
    window.LG = {};
    LG.me = {"userName": "${user.userName!""}", "trueName": "${user.name!""}", "userId": "${user.userId!0}","roleName":"${user.roleName!""}","usertoken":"${user.token!""}"};
...
<script src="js/angular/angular.min.js?v=${clientVersion}"></script>
...
<!--ng-file-upload-->
<script src="js/plugins/ng-file-upload-bower/ng-file-upload.min.js"></script>
<script src="js/plugins/ng-file-upload-bower/ng-file-upload-shim.min.js"></script>
...
<script src="app/components/minimaliza-sidebar.directive.js?v=11${clientVersion}"></script>
